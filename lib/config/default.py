...
_C.TEST.MODEL_FILE = "/home/tj/QCR_PubMedCLIPs_fusion/output/qcr/clip_ae/roco/VQASLAKE/QCR.CLIP.AE.ROCO.VQASLAKE.16batchsize.200epoch.withTFIDF.nondeterministic/179_best.pth"
_C.TEST.RESULT_DIR = "./testout/"
...
_C.CC = CN()
_C.CC.HIDDEN_SIZE= 1024
# _C.CC.INPUT_SIZE= 1088
_C.CC.DROPOUT_R=0.1
_C.CC.MULTI_HEAD=8
_C.CC.HIDDEN_SIZE_HEAD=64
_C.CC.LAYER=6
_C.CC.FF_SIZE=2048
_C.CC.FLAT_MLP_SIZE=512
_C.CC.FLAT_GLIMPSES=1  
_C.CC.FLAT_OUT_SIZE=2048
_C.CC.dropout=0.1
_C.CC.hidden_size=1024
_C.CC.num_heads=8
_C.CC.n_layers=2
